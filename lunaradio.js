...
- PLAYER ADAPTADO y HABILITADO PARA ZENO
- API PARA METADATA LOCAL O REMOTA      ejemplo.com/api.php?url=
- VERSION MODIFICADA V1.0 - 2025 by NITIDO!
*/
...
if ("" != xa) {
var b = xa.replace(/ *\([^)]*\) */g, ""),
a = b = "https://itunes.apple.com/search?limit=1&term=" + encodeURIComponent(b) + "&media=music&limit=1&url=" + encodeURIComponent(ha),
h = a,
p = "GET";
...
method: "GET",
crossDomain: !0,
url: url_api+ia+"/status-json.xsl",
success: function(v) {
try {
v =
JSON.parse(v);
...
method: "GET",
crossDomain: !0,
url: url_api+ia+"/currentsong?sid=" + Eb,
success: function(v) {
y(v, "")
},
error: function(v, z, m) {
...
method: "GET",
crossDomain: !0,
url: url_api+"https://api.radionomy.com/currentsong.cfm?radiouid=" + Fb + "&apikey=" + Gb + "&callmeback=yes&type=xml&cover=yes&previous=yes",
success: function(b) {
try {
...
method: "GET",
crossDomain: !0,
url: url_api+"https://www.radiojar.com/api/stations/" + Hb + "/now_playing/?rand=" + Math.random(),
success: function(b) {
try {
var a = JSON.parse(b);
...
method: "GET",
crossDomain: !0,
url: url_api+"https://public.radio.co/stations/" + Ib + "/status",
success: function(b) {
try {
var a = JSON.parse(b);
...
method: "GET",
crossDomain: !0,
url: url_api+"https://zenoplay.zenomedia.com/api/zenofm/nowplaying/"+zenoid+"/?rand="+ Math.random(),
success: function(b) {
try {
var a = JSON.parse(b);
y(a.artist + a.title, a.thumb)
